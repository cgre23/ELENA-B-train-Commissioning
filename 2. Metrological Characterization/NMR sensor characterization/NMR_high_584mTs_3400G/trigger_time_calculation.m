...
filename = sprintf('NMRanalysis510_3400G_%d.mat',k);
...
time = time_or - time_or(1,1);
freq = 1/(time(5)-time(4));
...
time_index_NMRop = find(nmr_op < 0.34, 100);
time_index_NMRsp = find(nmr_sp < 0.34, 100);
