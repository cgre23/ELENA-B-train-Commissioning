...
%% Load data
r3=22000:32350;  r4=23000:40000;  r6=24000:46000;  r9=24000:37000;  r12=24000:38200;  r15=24000:40000;  r18=25000:42400; 
load('data/Cycle_40A_900As.mat');
I40 = curr(r3);
B40 = BdL(r3);
t40 = tim(r3); grad_est = grad_est'; 
g40 = grad_est(r3); g40(3137:3145) = 900;
load('data/Cycle_50A_900As.mat'); 
I50 = curr(r4);
B50 = BdL(r4);
t50 = tim(r4); grad_est = grad_est';
g50 = grad_est(r4); g50(3055:3061) = 900;
load('data/Cycle_100A_900As.mat'); 
I100 = curr(r6);
B100 = BdL(r6);
t100 = tim(r6); grad_est = grad_est';
g100 = grad_est(r6); g100(2441:2446) = 900;
load('data/Cycle_150A_900As.mat'); 
I150 = curr(r9);
B150 = BdL(r9);
t150 = tim(r9); grad_est = grad_est';
g150 = grad_est(r9); g150(2278:2284) = 900;
load('data/Cycle_200A_900As.mat');
I200 = curr(r12);
B200 = BdL(r12);
t200 = tim(r12); grad_est = grad_est';
g200 = grad_est(r12); g200(2503:2509) = 900;
load('data/Cycle_250A_900As.mat'); 
I250 = curr(r15);
B250 = BdL(r15);
t250 = tim(r15); grad_est = grad_est';
g250 = grad_est(r15);
load('data/Cycle_276A_900As.mat'); 
I276 = curr(r18);
B276 = BdL(r18);
...
b=3060; c=3060;
 ...
 e40d = z1(i40d:(i40d+c)); 
 e50d = z2(i50d:i50d+c); 
 e100d = z3(i100d:i100d+c); 
 e150d = z4(i150d:i150d+c); e200d = z5(i200d:i200d+c); e250d = z6(i250d:i250d+c); e276d = z7(i276d:i276d+c); 
% 
